...
Descriptive statistics are a vital part in interpreting a dataset. It allows the reader and user(s) of the code to get an understanding of the data. In this case, we are taking a very large number of observations and turning it into something simple. The descriptive statstics below can help movie production companies estimate if they are below, the same, or above industry standard when it comes to revenue. For example the entertainment conglomorate, Disney could look at the average in order to estimate how much money their next film should be able to bring in. 
