...
##Summary Statistics 
Descriptive statistics are a vital part in interpreting a dataset. It allows the reader and user of the code to get an understanding of the data. In this case, we are taking a very large number of observations and turning it into something simple. The descriptive statstics below can help movie production companies estimate if they are below, the same, or above industry standard when it comes to revenue. 
...
```
## Analysis 6: Does the budget of a movie effect Revenue? - Rachel Worden
